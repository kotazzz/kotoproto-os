...
PNG в `assets/faces/` — готовые исходники. Пакер только вшивает их в прошивку (плюс миниатюры OLED) и не пересобирает пиксели из Toaster Blaster.

Пересборка таблиц лиц после правок PNG или `assets/emotions.json`:
...
assets/             emotions.json + RGB-лица (исходники)
